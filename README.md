...
Simple, unopinionated, lightweight and extensible state management for Vue 3. Take a look at the demo [here](https://harlemjs.com/demo/basic) to see it in action or play around with it on CodeSandbox: [Demo](https://codesandbox.io/s/harlem-demo-lmffj).
